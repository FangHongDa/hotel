...
public class Order {
    ...
    public Order(Integer orderId, Integer orderTypeId, String payOrderId, String orderType, Integer userId, String name, String phone, Integer roomTypeId, String roomType, Date orderDate, Integer orderDays, Integer orderStatus, Double orderCost, Date createTime, Date updateTime) {
        this.orderId = orderId;
        this.orderTypeId = orderTypeId;
        this.payOrderId = payOrderId;
